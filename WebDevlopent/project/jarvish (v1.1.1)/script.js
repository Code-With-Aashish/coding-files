...
fridayComs.push("are you there - to check jarvish presence");
fridayComs.push("shutdown - stop voice recognition");
...
fridayComs.push("open web host");
fridayComs.push("open instagram");
fridayComs.push("open my instagram account");
fridayComs.push("open code uplode - for the github");
fridayComs.push("open calender");
fridayComs.push("open chat gpt");
fridayComs.push("top headlines");
fridayComs.push("news regarding");
fridayComs.push("what my bio");
fridayComs.push("what the temprature");
fridayComs.push("tell about yourself");
fridayComs.push("connection status");
fridayComs.push("current time");
fridayComs.push("what the charging status");
fridayComs.push("what the current charge");
fridayComs.push("what my name");
fridayComs.push("open music");
fridayComs.push("full weather report");
fridayComs.push("close all tab - to close all the tab");
fridayComs.push("open my code uplode account - for open the github account");
...
recognition.onresult = function (event) {
    ...
    if (localStorage.getItem("lang") === "en-US") {
        ...
        if (transcript.includes("what the current charge")) {
            readOut(`the current charge is ${charge}`);
        }
        if (transcript.includes("what the charging status")) {
        ...
        // weather report
        if (
            transcript.includes("what the temperature")
        ) {
        ...
        // netlify
        if (transcript.includes("open web host")) {
            readOut("opening netlify");
            let a = window.open("https://app.netlify.com/");
            windowsB.push(a)
        }
        // spotify
        if (transcript.includes("open music")) {
        ...
        if (transcript.includes("what my name")) {
            readOut(`Sir, I know that you are ${JSON.parse(userData).name}`);
        }
        if (transcript.includes("what my bio")) {
        ...
        if (transcript.includes("open my instagram account")) {
            if (JSON.parse(userData).instagram) {
                readOut("opening your instagram account");
                let a = window.open(
